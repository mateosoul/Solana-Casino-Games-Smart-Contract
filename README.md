# Solana-Casino-Games-Smart-Contract

### Solana Casino Games — a decentralized suite of on-chain games including Dice, Roulette, Coin Flip, and Jackpot.

All games run entirely via Solana smart contracts, offering transparency, fair randomness, and instant results without intermediaries.

## 💡 Features:
• 100% on-chain logic (Anchor smart contracts)

• Wallet connection for real-time betting
